...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LIFECYCLE_CALLBACKS_TEXT_KEY = "lifecycleCallback";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            if(savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)){
                String previousContent = savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
                mLifecycleDisplay.setText(previousContent);
            }
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        String currentTextViewContent = mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, currentTextViewContent);
    }
