...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_RAW_JSON = "SEARCH_RAW_JSON";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            if(savedInstanceState.containsKey(QUERY_URL_KEY)) {
                String queryUrlContent = savedInstanceState.getString(QUERY_URL_KEY);
                mUrlDisplayTextView.setText(queryUrlContent);
            }
            if(savedInstanceState.containsKey(SEARCH_RAW_JSON)) {
                String searchResultsContent = savedInstanceState.getString(SEARCH_RAW_JSON);
                mSearchResultsTextView.setText(searchResultsContent);
            }
        }
    }
